...
C     
C     Process: g g > g > u u~ WEIGHTED<=2 @1
C     Process: g g > g > c c~ WEIGHTED<=2 @1
C     Process: g g > g > d d~ WEIGHTED<=2 @1
C     Process: g g > g > s s~ WEIGHTED<=2 @1
C     Process: g g > g > b b~ WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+IMAG1*AMP(1)
      JAMP(2,1)=-IMAG1*AMP(1)
