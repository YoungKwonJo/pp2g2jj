...
C     
C     Process: g g > g > g g WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      ...
      PARAMETER (NWAVEFUNCS=5, NCOLOR=4)
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     
      DATA DENOM(1)/6/
      DATA (CF(I,  1),I=  1,  4) /   19,   -2,   -2,    4/
C     1 Tr(1,2,3,4)
      DATA DENOM(2)/6/
      DATA (CF(I,  2),I=  1,  4) /   -2,   19,    4,   -2/
C     1 Tr(1,2,4,3)
      DATA DENOM(3)/6/
      DATA (CF(I,  3),I=  1,  4) /   -2,    4,   19,   -2/
C     1 Tr(1,3,4,2)
      DATA DENOM(4)/6/
      DATA (CF(I,  4),I=  1,  4) /    4,   -2,   -2,   19/
C     1 Tr(1,4,3,2)
C     ----------
C     BEGIN CODE
C     ----------
