...
C     
C     Process: u u~ > g > g g WEIGHTED<=2 @1
C     Process: c c~ > g > g g WEIGHTED<=2 @1
C     Process: d d~ > g > g g WEIGHTED<=2 @1
C     Process: s s~ > g > g g WEIGHTED<=2 @1
C     Process: b b~ > g > g g WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
